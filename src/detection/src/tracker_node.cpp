...
int main(int argc,char** argv)
{
    ...
    ros::Subscriber camera_sub = nh.subscribe("camera_rawArray", 10, &CameraTracker::KF, camera_tracker_ptr);
    ros::Subscriber lidar_sub  = nh.subscribe("lidar_rawArray", 10, &LidarTracker::KF, lidar_tracker_ptr);
